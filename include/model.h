...
//struct AABB
//{
//	glm::vec3 AA = glm::vec3(1e6, 1e6, 1e6);
//	glm::vec3 BB = glm::vec3(-1e6, -1e6, -1e6);
//};
...
public:
	...
	//	for (unsigned long long i = 0; i < meshes.size(); ++i)
	//	{
	//		for (unsigned long long j = 0; j < meshes[i].vertices.size(); ++j)
	//		{
	...
	//		}
	//	}
	//	AABB_box.AA = glm::vec3(xmax, ymax, zmax);
	//	AABB_box.BB = glm::vec3(xmin, ymin, zmin);
	//}
